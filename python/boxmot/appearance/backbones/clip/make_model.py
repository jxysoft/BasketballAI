...
def make_clipreid_model(num_classes=1000, pretrained=True, loss="softmax", **kwargs):
    model = OpenClipModel('ViT-L-14', 'openai',remove_proj=True)
    # load pretrained Checkpoint     
    # model_state_dict = torch.load("/Users/jxy/Projects/visions/yolo_tracking/examples/weights/creid_ViT-L-14_openai.pt", map_location=torch.device("cpu"))
